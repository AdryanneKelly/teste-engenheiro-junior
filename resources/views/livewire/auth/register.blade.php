        ...
        <div class="container mx-auto">
            <div class="flex flex-col items-center">
                <form wire:submit.prevent='register'
                    class="shadow-md shadow-purple-400 border-t-purple-400 border-t rounded-xl px-10 pb-10 mt-10">
                    ...
                    <h1 class="mt-10 text-white w-auto md:w-[450px] lg:w-[500px] font-medium">Cadastre-se</h1>
                    ...
                    <div class="flex flex-row w-full justify-center">
                        <button type="submit"
                            class="border-2 px-5 rounded-full py-2 items-end text-white text-sm hover:bg-slate-600 mt-6">Cadastrar</button>
                    </div>
                    <div class="flex flex-row w-full justify-center items-center mt-10 text-sm text-white">
                        Já tem uma conta?
                        <a href="{{ route('login') }}" class="text-orange-500 hover:text-orange-400 pl-1">
                            Login
                        </a>
                    </div>
                </form>
